...
public class SapaImplStatus2DrawerBackup implements Drawer<SapaImplStatus2DrawMaterial>, TitleDrawer, BodyDrawer {
      ...
      for (Status2Depth1Element status2Depth1Element : status2Depth0Element.getStatus1Depth1ElementList()) {
        ...
        try (PDPageContentStream contentStream = new PDPageContentStream(document, page,
          ...
          for (Status2Depth2FileTableElement fileData : fileTableInfo.getStatus2Depth2FileTableElementList()) {
            int rowIndex = fileTableInfo.getStatus2Depth2FileTableElementList().indexOf(fileData);
